...
use WPJoli\JoliClearLightBox\Log;
...
class JoliApplication
{
     ...
     * Use example:
     * JCLB()->requestService( WPJoli\JoliClearLightBox\Controllers\MenuController::class );
     */
    ...
    public function url($file = '', $min_first = false)
    {
        ...
        if ($min_first){
            ...
            // JCLB()->log($min_filepath);
            // JCLB()->log(file_exists($min_filepath));
