...
use  WPJoli\JoliClearLightBox\Controllers\Callbacks\SettingsCallbacks ;
use  WPJoli\JoliClearLightBox\Config\Settings ;
class SettingsController
{
    ...
    {
        $settings = (include JCLB()->path( 'config/defaults.php' ));
        return $settings;
    }
        ...
        foreach ( $settings as $group ) {
            ...
            foreach ( $group['sections'] as $section ) {
                ...
                foreach ( $section['fields'] as $field ) {
                    ...
                    //     [
                    //         'id' => 'min-width',
                    //         'title' => esc_html__('Minimum width', 'joli-clb'),
                    //         'type' => 'text',
                    //         'args' => [
                    //             'class' => 'ui-toggle'
                    //         ],
    ...
    public function setupSettings()
    {
        ...
        foreach ( $this->fields as $field ) {
            $option_item = null;
            //set the initial_value if exists or default as fallback
            $option_item[$field['option_id']] = ( $field['initial_value'] !== null ? $field['initial_value'] : $field['default'] );
            $options += $option_item;
        }
     ...
     */
    public function getOption( $name, $section, $default = false )
    {
